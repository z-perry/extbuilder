...
public class StandardComboBoxPropertyDescriptor extends PropertyDescriptor {
	...
	public StandardComboBoxPropertyDescriptor(Object id, String displayName, String[] displayStrings, Object[] items) {
	...
	public CellEditor createPropertyEditor(Composite parent) {
		CellEditor editor = new StandardComboBoxCellEditor(parent, displayStrings, items);
