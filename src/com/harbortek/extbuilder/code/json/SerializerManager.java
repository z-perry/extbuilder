...
public class SerializerManager {
	...
	static {
		...
		serializerTypes.put(ExtScript.class, new ScriptSerializer());
		serializerTypes.put(ExtElement.class, new VariableSerializer());
		//serializerTypes.put(ExtElementReference.class, new ReferenceSerializer());
		//serializerTypes.put(ExtFunctionReference.class, new ReferenceSerializer());
	...
	public static void serialize(Object objectSource,Writer os,CodeContext codeContext) {
		
		serialize(objectSource, os, false,codeContext);
	}
	
	public static void serialize(Object objectSource,Writer os,boolean force,CodeContext codeContext) {
		...
		if (objectSource != null) {
			...
			if (serializer != null) {
				serializer.serialize(objectSource,os,codeContext);
			}
		}
	}
