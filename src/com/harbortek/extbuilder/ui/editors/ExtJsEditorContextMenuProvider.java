...
public class ExtJsEditorContextMenuProvider extends ContextMenuProvider {
	 ...
	 */
	public ExtJsEditorContextMenuProvider(EditPartViewer viewer, ActionRegistry registry) {
		super(viewer);
		if (registry == null) {
